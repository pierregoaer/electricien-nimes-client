        ...
        <Layout>
            <main className="support-page-service-container">
                    ...
                    <div className="hero-section-padding">
                        <div className="support-page-text-block">
                            <h1>Installation électrique à Nîmes : Expertise résidentielle, commerciale et
                                industrielle</h1>
                            <p>Vous recherchez un professionnel compétent à Nîmes pour vos <strong>installations
                                électriques</strong> ?
                                Notre entreprise vous offre des solutions complètes et personnalisées pour tous vos
                                besoins.
                                Que ce soit : en installation électrique résidentielle, commerciale et industrielle,
                                nous
                                répondrons à votre besoin. Forts de notre expérience et de notre expertise, nous vous
                                garantissons un travail <Link to={'/services/renovation-et-mise-aux-normes'}> soigné et
                                    conforme aux normes électriques en vigueur <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    viewBox="0 0 24 24">
                                        <path
                                ...
                                nous
                                vous garantissons une sécurité optimale.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="secondary-section-padding">
                        <div className={styles.supportPageText}>
                            ...
                            <p>Lors de la construction ou de la rénovation d'une maison, il est essentiel de confier
                                <strong>l'installation électrique</strong> à un professionnel qualifié et expérimenté.
                                Nous sommes spécialisés dans les installations électriques
                            ...
                            <p>Notre équipe qualifiée vous accompagne tout au long de votre projet
                                ...
                                assurons de respecter la norme <a
                                    href='https://www.legrand.fr/pro/normes-et-reglementations/norme-nf-c-15-100/norme-nf-c-15-100-suivez-le-guide'
                                    target='_blank'>NF C 15-100 <svg xmlns="http://www.w3.org/2000/svg"
                                                                     viewBox="0 0 24 24">
                                    <path
                                        d="M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z"></path>
                                </svg></a> ainsi que les réglementations en vigueur.
                                Nous garantissons ainsi la sécurité de votre installation électrique.
                            </p>
                        ...
                        <ul className="bulleted-list-cards">
                            ...
                            <li className="bulleted-list-card bulleted-list-card-6">
                                <h4></h4>
                                <p><Link to={'/services/domotique-et-objets-connectes'}>La mise en place de systèmes de
                                    domotique et de gestion de l'énergie <svg xmlns="http://www.w3.org/2000/svg"
                                                                              viewBox="0 0 24 24">
                                        <path
                                            d="M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z"></path>
                                    </svg></Link></p>
                    ...
                    <div className="secondary-section-padding">
                        <div className={styles.supportPageText}>
                            ...
                            <p>Les installations électriques commerciales requièrent une expertise spécifique. Cette
                                ...
                                clients et employés. Nous mettons notre savoir-faire à
                    ...
                    <div className="secondary-section-padding">
                        <div className={styles.supportPageText}>
                            ...
                            <p>Les installations électriques industrielles sont complexes et requièrent une connaissance
                                approfondie des normes et des contraintes spécifiques à ce secteur. Nous avons développé
                                une expertise solide en matière
                ...
                <section>
                    <div className="secondary-section-padding">
                        <div className="support-page-text-block">
                            <p>Nous mettons notre expertise en <strong>installation
                                électrique
