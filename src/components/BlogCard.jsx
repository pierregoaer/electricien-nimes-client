        ...
        <div className={styles.blogCardContainer}>
            <div className={styles.blogCard}>
                <div className={styles.blogCardThumbnailContainer}>
                    <img className={styles.blogCardThumbnail} src={`https://res.cloudinary.com/dg8awj55m/image/upload/c_fill,h_500,w_800,f_auto/v1682719065/website-lending/electricien-nimes/images/${blogData.hero_image_url}`} alt={blogData.title}/>
                </div>
